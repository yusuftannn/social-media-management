  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'campaigns/:id', name: 'campaign-detail', component: () => import('@/features/campaigns/CampaignDetailView.vue') },
        { path: 'content', name: 'content', component: () => import('@/features/content/ContentView.vue') },
        { path: 'approvals', name: 'approvals', component: () => import('@/features/approvals/ApprovalsView.vue') },
